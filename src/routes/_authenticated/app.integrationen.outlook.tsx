...
export const Route = createFileRoute("/_authenticated/app/integrationen/outlook")({
  head: () => ({ meta: [{ title: "Outlook – HandwerkPilot" }] }),
  component: () => (
    <div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 text-muted-foreground">
              Verbinde HandwerkPilot mit deinem Outlook-Konto, um Termine zu synchronisieren, E-Mails Kunden zuzuordnen und Kunden-Mails direkt zu versenden.
            </p>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card icon={Send} title="Mail-Versand" text="Kunden-Mails direkt aus HandwerkPilot als Outlook-Entwurf oder Versand." />
      </div>
    </div>
  ),
});
